...
class _PembelianScreenState extends State<PembelianScreen> {
  ...
  Future<void> fetchPembelianData() async {
    final response =
        await http.get(Uri.parse('http://localhost:8080/api/pembelian/get.php'));
  ...
  Future<void> fetchBarangData() async {
    final response =
        await http.get(Uri.parse('http://localhost:8080/api/barang/get.php'));
    if (response.statusCode == 200) {
  ...
  Future<void> fetchSupplierData() async {
    final response =
        await http.get(Uri.parse('http://localhost:8080/api/supplier/get.php'));
  ...
  Future<void> addPembelian() async {
    ...
    final response = await http.post(
      Uri.parse('http://localhost:8080/api/pembelian/pembelian.php'),
