...
class _BarangScreenState extends State<BarangScreen> {
  ...
  Future<void> fetchBarangData() async {
    final response = await http.get(Uri.parse('http://localhost:8080/api/barang/get.php'));
  ...
  Future<void> fetchSupplierData() async {
    final response = await http.get(Uri.parse('http://localhost:8080/api/supplier/get.php'));
  ...
  Future<void> addBarang() async {
    final response = await http.post(
      Uri.parse('http://localhost:8080/api/barang/barang.php'),
